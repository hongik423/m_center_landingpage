          ...
          <nav className="flex items-center justify-between h-11 px-6 lg:px-8">
            ...
            <div className="hidden lg:flex items-center space-x-8">
              <Link
                ...
                className="text-sm text-gray-800 hover:text-gray-600 transition-colors duration-200 font-normal"
              >
                사업분석
              </Link>
          ...
          <div className="relative h-full flex flex-col">
            ...
            <div className="flex-1 px-6 py-8">
              <div className="space-y-6">
                <Link
                  href="/services/business-analysis"
                  className="block text-2xl text-gray-800 hover:text-gray-600 transition-colors duration-200 font-light py-2"
                  onClick={() => setIsMenuOpen(false)}
                >
                  사업분석
                </Link>
                ...
                <div className="border-t border-gray-200 pt-6 mt-8">
                  <Link
                    href="/tax-calculator"
                    className="block text-lg text-blue-600 hover:text-blue-700 transition-colors duration-200 font-medium py-2"
                    onClick={() => setIsMenuOpen(false)}
                  >
                    세금계산기
                  </Link>
