      ...
      <div className="container mx-auto px-4">
        <nav className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center space-x-3">
            <Button 
              className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white border-0 gap-2"
              ...
              <div className="py-6">
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <Link
                      href="/services/diagnosis"
                      className="flex items-center py-2 text-gray-700 hover:text-primary font-medium gap-2"
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
                      <Sparkles className="w-4 h-4 text-blue-600" />
                      무료AI진단신청
                  ...
                  <div className="space-y-3 pt-4 border-t">
                    <Button 
                      className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white border-0 gap-2"
                      onClick={() => {
