        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-gray-800 p-8 rounded-xl mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
              ...
              <div>
                <div className="font-semibold text-purple-400">휴대폰</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <button className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-4 px-8 rounded-xl text-lg transition duration-300">
              38단계 무료 진단
            </button>
