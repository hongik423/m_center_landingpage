                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    <div className="bg-white/60 p-3 rounded">
                      ...
                      <div className="text-xs text-blue-700">• 나이지리아 바이어 대상 영문 제안서 초안 생성</div>
                      <div className="text-xs text-blue-700">• 영문 제안서 작성 시간: 4시간 → 1시간</div>
                    </div>
                    <div className="bg-white/60 p-3 rounded">
                      <div className="font-semibold text-sm text-blue-800 mb-1">경영진 AI 활용</div>
                      <div className="text-xs text-blue-700">• 재무 분석 및 의사결정 지원</div>
                      <div className="text-xs text-blue-700">• 시장 분석 및 경쟁사 모니터링</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-8">
            ...
            {/* 케빈랩 사후관리 실제 성과 */}
            <div className="mt-8">
              <h4 className="font-bold text-lg text-gray-900 mb-4 text-center">📊 케빈랩 사후관리 실제 성과 (3개월 후)</h4>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">📅 실제 방문 일정 예시 (케빈랩 사례)</h3>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
            ...
            <CardContent className="p-8">
              ...
              <div className="grid md:grid-cols-5 gap-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">수행기관 '아이엔제이컨설팅' 선택</p>
                </div>
                <div className="text-center">
                ...
                <CardContent className="p-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="font-semibold">이후경 책임컨설턴트</div>
                        <div className="text-sm text-gray-600">아이엔제이컨설팅(주)</div>
                      </div>
                    </div>
                    <div className="flex items-center">
                      <Phone className="w-5 h-5 text-green-600 mr-3" />
                      <div>
                        <div className="font-semibold">010-9251-9743</div>
                        <div className="text-sm text-gray-600">전화 상담 가능</div>
                      </div>
                    </div>
                    <div className="flex items-center">
                      <Mail className="w-5 h-5 text-purple-600 mr-3" />
                      <div>
                        <div className="font-semibold">lhk@injc.kr</div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 opacity-90">
              케빈랩처럼 AI 일터혁신으로 <strong>업무 시간 80% 단축, 매출 35% 증가</strong>를 경험하세요
            </p>
            ...
            {/* 검증된 성과 수치 */}
            <div className="bg-white/10 rounded-lg p-6 mb-8">
              <h3 className="text-xl font-bold mb-4">📊 검증된 성과 (케빈랩 기준)</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                <div>
            ...
            <div className="space-y-4">
              ...
              <div className="text-center text-sm opacity-80">
                <p>📧 이메일 상담: <strong>lhk@injc.kr</strong></p>
                <p>🏢 수행기관: 아이엔제이컨설팅(주)</p>
              </div>
            </div>
            ...
            <div className="bg-yellow-400/20 rounded-lg p-4 mt-8">
              <p className="text-sm opacity-90">
                ...
                💡 <strong>신청 팁:</strong> 수행기관 선택 시 반드시 <strong>'아이엔제이컨설팅'</strong>을 선택해주세요
              </p>
            </div>

            <p className="text-sm opacity-80 mt-6">
              * 본 프로그램은 고용노동부 노사발전재단 주관 일터혁신 상생컨설팅 사업의 일환으로 정부에서 100% 지원하며, 
              케빈랩 실제 적용 사례를 바탕으로 검증된 효과를 제공합니다.
            </p>
          </div>
        </div>
      </section>
